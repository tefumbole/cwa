        ...
        return [
            ...
            'contact' => [
                ...
                'fields' => [
                    ...
                    'office_name'   => ['text', 'Office name', 'Catholic Women\'s Association'],
                    'office_line1'  => ['text', 'Office address line 1', 'Cameroon'],
                    'office_line2'  => ['text', 'Office address line 2', ''],
                    ...
                    'hours_weekday' => ['text', 'Business hours (Mon-Fri)', '9:00 AM - 5:00 PM'],
                    'hours_weekend' => ['text', 'Business hours (Sat-Sun)', 'By appointment'],
                ],
            ],
            'gallery' => [
                'label' => 'Gallery',

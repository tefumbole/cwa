@php
    $waPhone = preg_replace('/\D+/', '', \App\Support\SiteContent::text('contact.phone', '+237683155315'));
@endphp
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-16">
            ...
            <p class="text-lg text-gray-600 max-w-2xl mx-auto">
                {{ \App\Support\SiteContent::text('contact.intro', "Have a question, want to join a local group, or partner with us in service? Reach out to the Catholic Women's Association today.") }}
            </p>
        </div>
            ...
            <div class="lg:col-span-4 space-y-6">
                <div class="bg-white rounded-xl border-t-4 border-t-brand-blue shadow-md hover:shadow-lg transition-all p-6">
                    ...
                    <div class="space-y-3 text-gray-600">
                        <p class="font-semibold text-gray-800">{{ \App\Support\SiteContent::text('contact.office_name', "Catholic Women's Association — Head Office") }}</p>
                ...
                <div class="bg-white rounded-xl border-t-4 border-t-brand-gold shadow-md hover:shadow-lg transition-all p-6">
                    ...
                    <div class="space-y-4 text-gray-600">
                        <div>
                            <p class="font-bold text-gray-800">{{ \App\Support\SiteContent::text('contact.person_name', 'CWA Secretariat') }}</p>
                            <p class="text-sm text-gray-500">{{ \App\Support\SiteContent::text('contact.person_role', "Catholic Women\\'s Association") }}</p>
                        </div>
                        ...
                        <div class="flex items-center gap-3 pt-2">
                            ...
                            <a href="https://www.cwacmr.org" class="font-medium hover:text-brand-blue">{{ \App\Support\SiteContent::text('contact.website', 'www.cwacmr.org') }}</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-brand-blue text-white shadow-md rounded-xl overflow-hidden relative p-6">
                    ...
                    <div class="relative z-10 flex items-start gap-4">
                        ...
                        <div>
                            <h3 class="font-bold text-lg mb-2 text-brand-gold">Working Hours</h3>
                    ...
                    <div class="p-8 md:p-10">
                        <form id="contact-form" class="space-y-6" onsubmit="return submitContact(event)">
                            ...
                            <div class="pt-4 flex flex-col sm:flex-row gap-4">
                                ...
                                <a href="https://wa.me/{{ $waPhone }}?text={{ urlencode("Hello Catholic Women\\'s Association, I would like to inquire about...") }}"
